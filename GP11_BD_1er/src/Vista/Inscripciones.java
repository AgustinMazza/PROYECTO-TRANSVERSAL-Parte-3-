...
public class Inscripciones extends javax.swing.JInternalFrame {
    ...
    private void ConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ConfirmarActionPerformed
        int numFila = TablaIncripcion.getSelectedRow();
        int alumnito = Integer.parseInt(IDAlumno.getText());
        Object valor = TablaIncripcion.getValueAt(numFila, 0);
        int dato = Integer.parseInt(valor.toString());
        asignacion(alumnito, dato);
    ...
    private void cargarMaterias(int idAlumno) {
        ...
        if (botonInscribir.isSelected() && !botonDesinscribir.isSelected()) {
        ...
        } else if (botonDesinscribir.isSelected() && !botonInscribir.isSelected()) {
    ...
    private void asignacion(int alumnito, int materia) {

        String sql = "";

        if (botonInscribir.isSelected()) {

            sql = "INSERT INTO `inscripcion`(`nota`, `idAlumno`, `idMateria`) VALUES (0.0,?,?);";

            try (java.sql.Connection con = Conexion.getConexion(); PreparedStatement ps = con.prepareStatement(sql)) {

                ps.setInt(1, alumnito);
                ps.setInt(2, materia);
                ResultSet rs = ps.executeQuery();
                JOptionPane.showMessageDialog(null, "Inscripto con éxito");
                cargarMaterias(alumnito);
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(this, "Error al cargar inscripcion." + e.getMessage());
            }
            ...
            try (java.sql.Connection con = Conexion.getConexion(); 
                ...
                ps.setInt(2, materia);
                ResultSet rs = ps.executeQuery();
                JOptionPane.showMessageDialog(null, "Desinscrito con éxito");
                cargarMaterias(alumnito);
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(this, "Error al cargar inscripcion." + e.getMessage());
            }
