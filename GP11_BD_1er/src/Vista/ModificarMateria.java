...
public class ModificarMateria extends javax.swing.JInternalFrame {
    ...
    private void DarDeAltaMateriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DarDeAltaMateriaActionPerformed
        ...
        if (!IngresarIDMateria.getText().isEmpty() && Contrasena.getText().equalsIgnoreCase("123")) {
            int materia = (Integer.parseInt(IngresarIDMateria.getText()));
            ...
            try (java.sql.Connection con = Conexion.getConexion(); PreparedStatement ps = con.prepareStatement(sql)) {
                ...
                ps.setDouble(1, materia);
                ResultSet rs = ps.executeQuery();

                listarMateriasAltaBaja(Integer.parseInt(IngresarIDMateria.getText()));
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(this, "Error al habilitar materia." + e.getMessage());
            }
        }else{
            DefaultTableModel model = (DefaultTableModel) TablaAltaBajaMateria.getModel();
            model.setRowCount(0);
        }
    ...
    private void DarDeBajaMateriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DarDeBajaMateriaActionPerformed
        if (!IngresarIDMateria.getText().isEmpty() && Contrasena.getText().equalsIgnoreCase("123")) {
            ...
            try (java.sql.Connection con = Conexion.getConexion(); PreparedStatement ps = con.prepareStatement(sql)) {
                ...
                JOptionPane.showMessageDialog(this, "Error al des-habilitar materia." + e.getMessage());
            }
        }else{
            DefaultTableModel model = (DefaultTableModel) TablaAltaBajaMateria.getModel();
            model.setRowCount(0);
    ...
    private void listarMateriasAltaBaja(int idMateria) {
        ...
        String sql = "SELECT idMateria, nombre, estado "
                + "FROM materia "
                + "WHERE idMateria = ?";
